...
def add_users():
    ...
    with app.app_context():
        ...
        for user_data in users_data:
            ...
            if existing_user:
                print(f"⚠️  User already exists: {user_data['first_name']} {user_data['last_name']} ({user_data['email']})")
                skipped_count += 1
            else:
                # Create new user
                new_user = User(
                ...
                try:
                    ...
                    print(f"✅ Added: {user_data['first_name']} {user_data['last_name']} ({user_data['email']}) - Age: {user_data['age']}, City: {user_data['city']}")
                    added_count += 1
